...
class Patient(BaseModel):
    ...
    allergies: Annotated[bool,Field(default=None,max_length=5)]
...
patient_info = {'name':'kiran', 'email':'abc@gmail.com', 'linkedin_url':'http://linkedin.com/1322', 'age': '30', 'weight': 75.2,'contact_details':{'phone':'2353462'}}
